...
describe('DELETE /todos/:id', () => {
    ...
    it('should return 404 if cannot found todo', (done) => {
        var id = new ObjectID().toHexString();
            request(app)
            .delete(`/todos/${id}`)
            .expect(404)
    ...
    it('should return 400 if id is not correct type', (done) => {
         request(app)
            .delete(`/todos/123abc`)
            .expect(404)
            .end(done)
...
describe('POST /users', () => {
    ...
    it('should not create user when email in use', (done) => {
        var email= 'hoang@example.com';
        var password= 'Hoangspassword';
        request(app)
            .post('/users')
            .send({email,password})
            .expect(400)
